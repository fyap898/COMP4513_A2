    ...
    return(
        <div className="flex items-center gap-6 p-6 rounded-md bg-[#DAE2DF] border-[#6B8B93]">
            ...
            <div className="text-left space-y-1">
                ...
                <button className="mt-2 px-4 py-2 rounded-md bg-[#3D5C64] text-white font-semibold hover:bg-[#6B8B93]  cursor-pointer transition" onClick={() => props.learnMore(props.painting)}>Learn More</button>
            </div>
        </div>
    );
}

export default GalleryPaintingItem;